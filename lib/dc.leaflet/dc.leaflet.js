// Edits by Bruno Raimbault for MSF l: 668 and 745
...
dc.leafletChart = function (_chart) {
    ...
    var _tiles = function (map) {
        L.tileLayer('https://a.tile.openstreetmap.org/{z}/{x}/{y}.png', { //'D:/Users/IntUser/AppData/Local/.marble/data/maps/earth/openstreetmap/{z}/{x}/{y}.png', {#nb
...
dc.leafletChoroplethChart = function (parent, chartGroup) {
    ...
    _chart._postRender = function () {
        ...
        _info.update = function (name) {
                this._div.innerHTML = (name ? name: g.module_lang.text[g.module_lang.current].map_hover);    // #EDIT
            };
                ...
                layer.on("mouseover",function(){
                    if(v!==undefined){
                        if(g.colorscale_mapunitcurrent == 'Incidence'){
                            var info = _chart.popup()(feature) +": " +_chart.valueAccessor()(v.d).toFixed(2); // #EDIT
                        }else{
                            var info = _chart.popup()(feature) +": " +_chart.valueAccessor()(v.d).toFixed(0); // #EDIT
                        }
                    } else {
